...
function make_liuzhijin_api(en_name, zh_name){
  function url(keyword, callback){
    var data = {
      ...
      referrer: `https://music.liuzhijin.cn/?name=${encodeURI(keyword)}&type=${en_name}`,
      body: `input=${encodeURI(keyword)}&filter=name&type=${en_name}&page=1`,
    }
