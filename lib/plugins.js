...
function document_style(){
  ...
  $('body').append(`<div style="
    ...
    ">
        ...
        ">
          ...
          <!--
          <input id="paper_input" type="text"/ style="width: 100%;
          color:black;border: 0;-webkit-appearance: none;
          padding-top: 0px;
          padding-right: 0px;
          padding-left: 0px;
          padding-bottom: 0px;
  ...
  function handle(talk){
    ...
    if($('#form-settings-autoload-image').is(":checked"))
      ext = img.length ? ` <img src="${img.attr('data-src')}" style="float: right;"/>` : ""
    else
      ext = img.length ? ` <a href="${img.attr('data-src')}" target="_blank" style="float: right;">IMG</a>` : ""
