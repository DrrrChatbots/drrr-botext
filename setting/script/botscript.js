...
(function($PS) {
  ...
  var customStyle = (function () {
      ...
      return {
          ...
          opStart: v.opStart,
          opLetter: v.opLetter,
          reservedNames: [ "state", "true", "false", "event", "later", "going", "if", "else", "for", "while", "visit", "timer", "in", "of" ],
  ...
  var parseFLoop = function (exprP) {
      var desc = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(expect(Data_Identity.monadIdentity)(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(exprP)("For Init Expr")))(function (init) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(expect(Data_Identity.monadIdentity)(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(exprP)("For Cond Expr")))(function (cond) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(expect(Data_Identity.monadIdentity)(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(exprP)("For Step Expr")))(function (step) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(expect(Data_Identity.monadIdentity)(reserved("then")))(function () {
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(expect(Data_Identity.monadIdentity)(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(exprP)("Then Expr")))(function (thn) {
                      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.optionMaybe(Data_Identity.monadIdentity)(reserved("else")))(function (maybe) {
                          ...
                          throw new Error("Failed pattern match at BotScriptParser (line 334, column 3 - line 338, column 51): " + [ maybe.constructor.name ]);
                      });
                  });
              });
          });
  ...
  var parseWhile = function (exprP) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(reserved("while"))(function () {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(expect(Data_Identity.monadIdentity)(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(exprP)("While Pred")))(function (prd) {
  ...
  var $$delete = Data_Functor.voidRight(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(BotScript.Una.create("delete"))(reservedOp("delete"));
  ...
  var parseStmtExpr = function (exprP) {
      return Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(parseStmt(exprP))(function (stmtExpr) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.optional(Data_Identity.monadIdentity)(reservedOp(";")))(function () {
  ...
  var parsePmatch = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(parseIdentifier))(function ($$var) {
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.optionMaybe(Data_Identity.monadIdentity)(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(reservedOp(":"))(parseExpr)))(function (maybe) {
          ...
          throw new Error("Failed pattern match at BotScriptParser (line 135, column 5 - line 137, column 72): " + [ maybe.constructor.name ]);
      });
  });
  var parseExpr = Control_Lazy.fix(Text_Parsing_Parser.lazyParserT)(function (self) {
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(parseAbs(self))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(parseSimpleExpr(self))(function (expr) {
          return Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(parseBinding(self)(expr))(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(expr));
...
(function($PS) {
  ...
  var run = function (v) {
      ...
      if (v.exprs instanceof Data_List_Types.Cons && v.exprs.value0 instanceof Data_List_Types.Cons) {
          ...
          if (v.exprs.value0.value0 instanceof BotScript.Visit) {
              ...
              throw new Error("Failed pattern match at BotScriptVM (line 282, column 13 - line 295, column 38): " + [ v1.constructor.name ]);
          };
  ...
  var lvalUpdate = function (v) {
      return function (lval) {
          return function (val) {
              if (lval instanceof BotScript.Var) {
                  return Control_Applicative.pure(Effect.applicativeEffect)(BotScriptEnv.insert(v.env)(lval.value0)(val));
              };
              if (lval instanceof BotScript.Dot) {
                  return function __do() {
