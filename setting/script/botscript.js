...
(function($PS) {
  ...
  var Fun = (function () {
      function Fun(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Fun.create = function (value0) {
          return function (value1) {
              return new Fun(value0, value1);
          };
      };
      return Fun;
  })();
  ...
  var showExpr = new Data_Show.Show(function (v) {
      ...
      if (v instanceof Fun) {
          return "(Fun " + (Data_Show.show(showExpr)(v.value0) + (" " + (Data_Show.show(Data_Show.showArray(showExpr))(v.value1) + ")")));
      };
      if (v instanceof Seq) {
          return "(Seq " + (Data_Show.show(Data_List_Types.showList(showAction))(v.value0) + ")");
      };
      if (v instanceof Dot) {
      ...
      if (v instanceof Trm) {
          return v.value0.toString(Undefined["undefined"]);
      };
      throw new Error("Failed pattern match at BotScript (line 35, column 1 - line 58, column 46): " + [ v.constructor.name ]);
  });
  var showAction = new Data_Show.Show(function (v) {
      if (v instanceof Value) {
          return "(Value " + (Data_Show.show(showExpr)(v.value0) + ")");
      };
      ...
      if (v instanceof Timer) {
          return "(Timer " + (Data_Show.show(showExpr)(v.value0) + (" " + (Data_Show.show(showAction)(v.value1) + ")")));
      };
      ...
      if (v instanceof Visit) {
          return "(Visit " + (Data_Show.show(showExpr)(v.value0) + (" " + (Data_Show.show(showExpr)(v.value1) + (" " + (Data_Show.show(showAction)(v.value2) + ")")))));
      };
      if (v instanceof Ifels) {
          return "(Ifels " + (Data_Show.show(showExpr)(v.value0) + (" " + (Data_Show.show(showAction)(v.value1) + (" " + (Data_Show.show(showAction)(v.value2) + ")")))));
      };
      if (v instanceof Event) {
          return "(Event " + (Data_Show.show(Data_Show.showArray(Data_Show.showString))(v.value0) + (" " + (Data_Show.show(Data_Show.showArray(Data_Tuple.showTuple(Data_Show.showString)(Data_Show.showString)))(v.value1) + (" " + (Data_Show.show(showAction)(v.value2) + ")")))));
      };
      throw new Error("Failed pattern match at BotScript (line 77, column 1 - line 106, column 29): " + [ v.constructor.name ]);
  });
...
(function($PS) {
  ...
  var customStyle = (function () {
      ...
      return {
          ...
          opStart: v.opStart,
          opLetter: v.opLetter,
          reservedNames: [ "state", "true", "false", "event", "delay", "going", "if", "else" ],
          reservedOpNames: [ ":", "," ],
          caseSensitive: false
      };
  })();
  ...
  var parseBinding = function (exprP) {
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(exprP)(mustLval(Data_Identity.monadIdentity))))(function (lval) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(whiteSpace)(function () {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(symbol("="))(symbol("+=")))(symbol("-=")))(symbol("*=")))(symbol("/=")))(symbol("%=")))(function (op) {
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(exprP)("Binding Expression"))(function (expr) {
                      if (op === "+=") {
                      ...
                      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new BotScript.Renew(lval, expr));
                  });
              });
          });
      });
  ...
  var call = function (exprP) {
      return parens(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.sepBy(Data_Identity.monadIdentity)(exprP)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(",")))(function (args) {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(function (expr) {
              return new BotScript.Fun(expr, Data_Array.fromFoldable(Data_List_Types.foldableList)(args));
          });
      }));
  };
  var brackets = function (p) {
  ...
  var parseArray = function (exprP) {
      return Control_Lazy.fix(Text_Parsing_Parser.lazyParserT)(function (self) {
          return brackets(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))((function () {
              ...
              return function ($40) {
                  return BotScript.Arr.create($39($40));
              };
          })())(Text_Parsing_Parser_Combinators.sepBy(Data_Identity.monadIdentity)(exprP)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(","))));
      });
  };
  var parseTerm = function (exprP) {
      return Text_Parsing_Parser_Combinators.choice(Data_Foldable.foldableArray)(Data_Identity.monadIdentity)([ parseArray(exprP), Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))((function () {
          var $41 = BotScript.toTerm("String");
          return function ($42) {
              return BotScript.Trm.create($41($42));
          };
      })())(parseStringLiteral), Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))((function () {
          var $43 = BotScript.toTerm("Number");
          return function ($44) {
              return BotScript.Trm.create($43($44));
          };
      })())(parseNumber), Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))((function () {
          var $45 = BotScript.toTerm("Boolean");
          return function ($46) {
              return BotScript.Trm.create($45($46));
          };
      })())(parseBoolean), Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(BotScript.Var.create)(parseIdentifier), parens(exprP) ]);
  };
  var parseEtypes = Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(brackets(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_Array.fromFoldable(Data_List_Types.foldableList))(Text_Parsing_Parser_Combinators.sepBy(Data_Identity.monadIdentity)(parseEtype)(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(",")))))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(parseEtype)(function (et) {
  ...
  var sub = function (exprP) {
      return brackets(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(exprP)(function (sub1) {
          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(function (expr) {
              return new BotScript.Sub(expr, sub1);
          });
      }));
  };
  var braces = function (p) {
  ...
  var parseSeq = function (actionP) {
      return braces(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(BotScript.Seq.create)(Data_List.many(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(actionP)));
  };
  ...
  var op$primetab = function (exprP) {
      return [ [ prefix(Data_Identity.monadIdentity)(Text_Parsing_Parser_Combinators.choice(Data_Foldable.foldableArray)(Data_Identity.monadIdentity)([ neg, not, inc$primep, dec$primep ])) ], [ postfix(Data_Identity.monadIdentity)(Text_Parsing_Parser_Combinators.choice(Data_Foldable.foldableArray)(Data_Identity.monadIdentity)([ call(exprP), dot, sub(exprP), inc$primes, dec$primes ])) ], [ binary("<")(Text_Parsing_Parser_Expr.AssocLeft.value) ], [ binary("<=")(Text_Parsing_Parser_Expr.AssocLeft.value) ], [ binary(">")(Text_Parsing_Parser_Expr.AssocLeft.value) ], [ binary(">=")(Text_Parsing_Parser_Expr.AssocLeft.value) ], [ binary("in")(Text_Parsing_Parser_Expr.AssocLeft.value) ], [ binary("===")(Text_Parsing_Parser_Expr.AssocLeft.value) ], [ binary("==")(Text_Parsing_Parser_Expr.AssocLeft.value) ], [ binary("!==")(Text_Parsing_Parser_Expr.AssocLeft.value) ], [ binary("!=")(Text_Parsing_Parser_Expr.AssocLeft.value) ], [ binary("/")(Text_Parsing_Parser_Expr.AssocLeft.value) ], [ binary("%")(Text_Parsing_Parser_Expr.AssocLeft.value) ], [ binary("*")(Text_Parsing_Parser_Expr.AssocLeft.value) ], [ binary("-")(Text_Parsing_Parser_Expr.AssocLeft.value) ], [ binary("+")(Text_Parsing_Parser_Expr.AssocLeft.value) ], [ binary("&&")(Text_Parsing_Parser_Expr.AssocRight.value) ], [ binary("||")(Text_Parsing_Parser_Expr.AssocRight.value) ] ];
  };
  var parseExpr = function (actionP) {
      return Control_Lazy.fix(Text_Parsing_Parser.lazyParserT)(function (self) {
          var exprP = Text_Parsing_Parser_Expr.buildExprParser(Data_Identity.monadIdentity)(op$primetab(self))(parseTerm(self));
          return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(whiteSpace)(function () {
              return Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(exprP)(parseSeq(actionP)))("Expression");
          });
      });
  };
  var parseAction = Control_Lazy.fix(Text_Parsing_Parser.lazyParserT)(function (self) {
      var exprP = parseExpr(self);
      return Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(parseBinding(exprP))(braces(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(BotScript.Group.create)(Data_List.many(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(self)))))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(BotScript.Delay.create)(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(reserved("delay"))(exprP))))(Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(reserved("event"))(function () {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(parseEtypes)(function (name) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(parseRules)(function (rules) {
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(self)(function (action) {
      ...
      })))(Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(reserved("if"))(function () {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(exprP)("If Pred"))(function (prd) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(self)("Then Action"))(function (thn) {
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.optionMaybe(Data_Identity.monadIdentity)(reserved("else")))(function (maybe) {
                      if (maybe instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(self)("Else Action"))(function (els) {
                      ...
                      throw new Error("Failed pattern match at BotScriptParser (line 256, column 11 - line 260, column 59): " + [ maybe.constructor.name ]);
                  });
              });
          });
      })))((function () {
          var desc = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(self)("For Init Action"))(function (init) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(exprP)("For Cond Expr"))(function (cond) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.optional(Data_Identity.monadIdentity)(reserved(";")))(function () {
                      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(self)("For Step Action"))(function (step) {
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(reserved("for"))(function () {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(parens(desc))(desc))(function (v) {
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(self)("For Body Action"))(function (body) {
                      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new BotScript.Group(Data_List.fromFoldable(Data_Foldable.foldableArray)([ v.value0, new BotScript.While(v.value1.value0, new BotScript.Group(Data_List.fromFoldable(Data_Foldable.foldableArray)([ body, v.value1.value1 ]))) ])));
                  });
              });
          });
      })()))(Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(reserved("while"))(function () {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(exprP)("Pred"))(function (prd) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(self)("While Action"))(function (act) {
      ...
      })))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(reserved("going"))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(BotScript.Going.create)(parseIdentifier))))(Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(reserved("timer"))(function () {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(exprP)("Timer Period"))(function (prd) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(self)("Timer Action"))(function (act) {
      ...
      })))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(BotScript.Value.create)(exprP))))(function (action) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.optional(Data_Identity.monadIdentity)(reserved(";")))(function () {
              return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(action);
          });
  ...
  var parseScript = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(Data_Array.some(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(parseScript$prime))("check"))(function (xs) {
...
(function($PS) {
      ...
      return function (rules) {
          return function (enviorn) {
              return Data_Foldable.foldr(Data_Foldable.foldableArray)(function (v) {
                  return function (acc) {
                      return BotScriptEnv.insert(acc)(v.value0.value0)(BotScript.toTerm("String")(v.value1));
                  };
  ...
  var runActions = function (v) {
      if (v.as instanceof Data_List_Types.Nil) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.log("Wrong Action.")))(function () {
      ...
      if (v.as instanceof Data_List_Types.Cons && (v.as.value0 instanceof Data_List_Types.Nil && v.as.value1 instanceof Data_List_Types.Nil)) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.log("Action Done.")))(function () {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Control_Monad_Rec_Class.Done(Data_Unit.unit));
          });
      };
      ...
      if (v.as instanceof Data_List_Types.Cons && v.as.value0 instanceof Data_List_Types.Cons) {
          var next$primeloop = new Control_Monad_Rec_Class.Loop({
          ...
          if (v.as.value0.value0 instanceof BotScript.Going) {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(DrrrBot.unlisten(v.sn)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)($foreign.clearTimer(v.sn)))(function () {
                          return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Control_Monad_Rec_Class.Loop({
              ...
              throw new Error("Failed pattern match at BotScriptVM (line 105, column 13 - line 118, column 35): " + [ v1.constructor.name ]);
          };
          ...
          if (v.as.value0.value0 instanceof BotScript.Value) {
              var val = evalExpr(v)(v.e)(v.as.value0.value0.value0);
          ...
          if (v.as.value0.value0 instanceof BotScript.Value) {
              var val = evalExpr(v)(v.e)(v.as.value0.value0.value0);
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.log(val.toString(Undefined["undefined"]))))(function () {
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(next$primeloop);
              });
          };
          if (v.as.value0.value0 instanceof BotScript.Ifels) {
              var prd$prime = evalExpr(v)(v.e)(v.as.value0.value0.value0);
              var act$prime = $foreign.bool(prd$prime)(v.as.value0.value0.value1)(v.as.value0.value0.value2);
              return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Control_Monad_Rec_Class.Loop({
                  as: new Data_List_Types.Cons(new Data_List_Types.Cons(act$prime, v.as.value0.value1), v.as.value1),
                  e: v.e,
                  sn: v.sn,
                  s: v.s
              }));
          ...
          if (v.as.value0.value0 instanceof BotScript.While) {
              var prd$prime = evalExpr(v)(v.e)(v.as.value0.value0.value0);
              var nxt$prime = $foreign.bool(prd$prime)(new Data_List_Types.Cons(v.as.value0.value0.value1, new Data_List_Types.Cons(v.as.value0.value0, v.as.value0.value1)))(v.as.value0.value1);
              return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Control_Monad_Rec_Class.Loop({
                  as: new Data_List_Types.Cons(nxt$prime, v.as.value1),
                  e: v.e,
                  sn: v.sn,
                  s: v.s
              }));
          };
          if (v.as.value0.value0 instanceof BotScript.Timer) {
              var prd$prime = evalExpr(v)(v.e)(v.as.value0.value0.value0);
              var act$prime = act2effunit(v.as.value0.value0.value1)(v.sn)(v.s)(v.e);
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)($foreign.setTimer(v.sn)(prd$prime)(act$prime)))(function () {
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(next$primeloop);
              });
          };
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)((function () {
              if (v.as.value0.value0 instanceof BotScript.Delay) {
                  var expr$prime = evalExpr(v)(v.e)(v.as.value0.value0.value0);
                  var period = $foreign.toNumber(expr$prime);
                  return Effect_Aff.delay(period);
              };
      ...
      throw new Error("Failed pattern match at BotScriptVM (line 58, column 1 - line 69, column 25): " + [ v.constructor.name ]);
  };
  ...
  var lvalUpdate = function (ms) {
      return function (env) {
          return function (lval) {
              return function (val) {
                  if (lval instanceof BotScript.Var) {
                      return BotScriptEnv.insert(env)(lval.value0)(val);
                  };
                  if (lval instanceof BotScript.Dot) {
                      var obj$prime = evalExpr(ms)(env)(lval.value0);
                      var v = $foreign.updMem(obj$prime)(lval.value1)(val);
                      return env;
                  };
                  if (lval instanceof BotScript.Sub) {
                      var sub$prime = evalExpr(ms)(env)(lval.value1);
                      var obj$prime = evalExpr(ms)(env)(lval.value0);
                      var v = $foreign.updMem(obj$prime)(lval.value1)(val);
                      return env;
                  };
  ...
  var evalExpr = function (ms) {
      return function (env) {
          return function (v) {
              if (v instanceof BotScript.Arr) {
                  return BotScript.toTerm("Array")(Data_Functor.map(Data_Functor.functorArray)(evalExpr(ms)(env))(v.value0));
              };
              if (v instanceof BotScript.Bin) {
                  var rv$prime = evalExpr(ms)(env)(v.value2);
                  var lv$prime = evalExpr(ms)(env)(v.value1);
                  return $foreign.evalBin(v.value0)(lv$prime)(rv$prime);
              };
              if (v instanceof BotScript.Una) {
                  var val$prime = evalExpr(ms)(env)(v.value1);
                  var val$prime$prime = $foreign.evalUna(v.value0)(val$prime);
                  if (v.value0 === "_++") {
                      var v1 = lvalUpdate(ms)(env)(v.value1)(val$prime$prime);
                      return val$prime;
                  };
                  if (v.value0 === "_--") {
                      var v1 = lvalUpdate(ms)(env)(v.value1)(val$prime$prime);
              ...
              if (v instanceof BotScript.Fun) {
                  var args$prime = Data_Functor.map(Data_Functor.functorArray)(evalExpr(ms)(env))(v.value1);
                  if (v.value0 instanceof BotScript.Dot) {
                      var obj$prime = evalExpr(ms)(env)(v.value0.value0);
                      var mem$prime = BotScript.toTerm("String")(v.value0.value1);
                      return $foreign.evalFun(obj$prime)(mem$prime)(args$prime);
                  };
                  if (v.value0 instanceof BotScript.Sub) {
                      var sub$prime = evalExpr(ms)(env)(v.value0.value1);
                      var obj$prime = evalExpr(ms)(env)(v.value0.value0);
                      return $foreign.evalFun(obj$prime)(sub$prime)(args$prime);
                  };
                  var expr$prime = evalExpr(ms)(env)(v.value0);
                  return $foreign.evalFun(expr$prime)(Undefined["undefined"])(args$prime);
              };
              if (v instanceof BotScript.Sub) {
                  var sub$prime = evalExpr(ms)(env)(v.value1);
                  var obj$prime = evalExpr(ms)(env)(v.value0);
                  return $foreign.memberOf(obj$prime)(sub$prime);
              };
              if (v instanceof BotScript.Dot) {
                  var obj$prime = evalExpr(ms)(env)(v.value0);
                  var mem$prime = BotScript.toTerm("String")(v.value1);
                  return $foreign.memberOf(obj$prime)(mem$prime);
              };
              if (v instanceof BotScript.Var) {
                  var v1 = BotScriptEnv.assocVar(v.value0)(env);
                  if (v1 instanceof Data_Maybe.Just) {
                      return v1.value0;
                  };
                  if (v1 instanceof Data_Maybe.Nothing) {
  ...
  var acts2effunit = function (acts) {
      return function (sname) {
          return function (states) {
              return function (env) {
                  return function (any) {
                      return Data_Functor["void"](Effect.functorEffect)(Effect_Aff.launchAff(Control_Monad_Rec_Class.tailRecM(Effect_Aff.monadRecAff)(runActions)({
                          as: new Data_List_Types.Cons(acts, Data_List_Types.Nil.value),
                          e: env,
                          sn: sname,
                          s: states
                      })));
  ...
  var act2effunit = function (act) {
      return function (sname) {
          return function (states) {
              return function (env) {
                  return acts2effunit(new Data_List_Types.Cons(act, Data_List_Types.Nil.value))(sname)(states)(env);
              };
          };
      };
  };
...
(function($PS) {
  ...
  var execute = function (ctx1) {
      ...
      throw new Error("Failed pattern match at Main (line 18, column 15 - line 20, column 44): " + [ v.constructor.name ]);
  };
  var ctx = "\x0aevent msg (user : \"\", msg : \"\u55b5\") { drrr.print(\"\u6c6a\")};\x0a";
  var compile = function (ctx1) {
      ...
      throw new Error("Failed pattern match at Main (line 22, column 15 - line 24, column 44): " + [ v.constructor.name ]);
  };
  exports["ctx"] = ctx;
